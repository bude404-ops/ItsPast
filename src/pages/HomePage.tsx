...
export function HomePage() {
  return <section className="space-y-6">
    ...
    <section className="space-y-3"><p className="text-xs font-bold uppercase tracking-[0.24em] text-stone-500">Places near you with a past</p>{demoEntities.slice(0,3).map((entity) => <EntityCard key={entity.id} entity={entity} />)}</section>
  </section>;
}
