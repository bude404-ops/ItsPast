...
export interface HistoricalSource { id: string; sourceType: SourceType; title: string; publisher?: string; author?: string; publicationDate?: string; url?: string; archiveReference?: string; copyrightStatus?: string; description: string; confidence: ConfidenceLevel; demoData: true; }
